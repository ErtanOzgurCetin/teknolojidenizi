...
function addCart(productid, stock) {
		...
		$.ajax(
			{
				...
				success: function (data) {
					if (data.indexOf("~") == -1) {
						$('#modalSepet .modal-body').text(data + " ürününden " + istenilenMiktar + " adet sepete eklendi")
	...
	}  else if (stock == 0) alert("Bu ürün stoklarda mevcut değil") 

    
	else {
		alert("Bu üründen en fazla " + stock + " adet sipariş   edebilirsiniz")
	}
}
...
//				$(".total-cost span").text(data.totalPrice);
//			} else if (data.error) {
//				alert(data.error);
//			}
//		},
//		error: function (e) {
//			alert("Hata oluştu: " + e.responseText);
//		}
//	});
//}
